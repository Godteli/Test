...
local Stats = Library:Tab("Stats","rbxassetid://7040410130")
    ...
    local Race = Library:Tab("Race v4","rbxassetid://13093762160")
    --------------------------------------------------------------------
...
spawn(function()
    ...
    Setting:Toggle("Fast Attack 3",false,function(Fast)
    _G.FastAttack = Fast
end)
...
Setting:Toggle("Fast Attack 4",false,function(value)
...
Setting:Toggle("Fast Attack 5",false,function(value)
            _G.FastAttack = value
        end)



    Setting:Toggle("Very Fast Attack 1",false,function(value)
...
while cac() do 
	AttackNoCD()
        ...
        Setting:Toggle("Very Fast Attack 2",nil,function(value)
...
Update:Notification("Hello, "  ..game.Players.LocalPlayer.DisplayName.. " Welcome LDQ HUB V1!")
