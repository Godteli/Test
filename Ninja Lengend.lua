local LDQHUB = Instance.new("ScreenGui")
...
LDQHUB.Name = "LDQHUB"
LDQHUB.Parent = game.CoreGui
LDQHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
local osfunc = {}
 ...
 WindowStrokemain.Archivable = true
	...
	Logo.Image = "rbxassetid://12844034959"
...
local WindowStrokelol = Instance.new("UIStroke")
 ...
 Tab.Image = "rbxassetid://12844034959"
...
--------------------------------------------------------------------
 local Library = Update:Window("LDQ");
--------------------------------------------------------------------
 local Main = Library:Tab("Main","rbxassetid://6026568198")
--------------------------------------------------------------------
  Main:Seperator("「 Credits 」")
    Main:Label("Made By BinxGodteli#7820 ")
...
setclipboard("https://discord.gg/ppDqYsPUSm")
      ...
      Main:Seperator("「Feature」")

Main:Toggle("Auto swing", "Auto swing (auto farm)", function(v)
    getgenv().autoswing = v
    while true do
...
Main:Toggle("Auto sell", "Auto sell (auot farm too)", function(v)
    getgenv().autosell = v
    while true do
...
Main:Toggle("Auto buy swords", "Auto buy swords", function(v)
    getgenv().buyswords = v
    while true do
...
Main:Toggle("Auto buy betls", "Auto buy belts", function(v)
    getgenv().buybelts = v
    while true do
...
Main:Toggle("Auto buy ranks", "Auto buy ranks", function(State)
    Ranks = State
    while Ranks do
    wait(1)
    local deku1 = "buyRank"
...
Main:Button("Get all elements", function()
